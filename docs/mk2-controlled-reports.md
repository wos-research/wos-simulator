...
The [machine-readable cases](../testcases/mk2/controlled.json) include complete predictive army stats, troop counts, recorded seeds and observed outcomes. [Native Lua vectors](../simulator/src/mk2/fixtures/native-lua.json) are retained separately for RNG regression. [The 301 original reference cases](../simulator/src/mk2/fixtures/reference.json) are a separate regression set, not 301 additional validated in-game battles. See [integration and replay instructions](mk2-integration.md).
