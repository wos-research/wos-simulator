...
**Current checkpoint:** [Catalogue19](installed-catalogue19-validation-20260914.md) matches516/516 reviewed controlled reports using their recorded seeds. It adds two exact-scope Ambusher reservation rules and20 reports; earlier dated counts and candidate statuses below are historical. External inbox cases and ongoing new experiments remain separate.
