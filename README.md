...
[readable report catalog](docs/mk2-controlled-reports.md). The [v17 checkpoint](docs/mk2-ordering-v17-checkpoint-20260913.md) reproduces **461/461 controlled reports** using recorded seeds, including the previously pending mixed-skill cohorts. This checks winners, all six survivor counts and every explicit supported chance-skill count within the tested scope. Separate external inbox cases still include mismatches and unsupported profiles. Earlier [campaign evidence](docs/mk2-campaign-20260913.md) and [research notes](docs/mk2-pending-research.md) preserve the development history. All replay inputs, recorded seeds and available observations are included under `testcases/mk2/`; raw identifying network captures remain private.
