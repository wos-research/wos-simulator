...
[readable report catalog](docs/mk2-controlled-reports.md). The [latest Lancer checkpoint](docs/mk2-opposing-lance-checkpoint-20260913.md) brings v17 to **471/471 controlled reports** using recorded seeds, including the previously pending mixed-skill cohorts. This checks winners, all six survivor counts and every explicit supported chance-skill count within the tested scope. Separate external inbox cases still include mismatches and unsupported profiles. Earlier [campaign evidence](docs/mk2-campaign-20260913.md) and [research notes](docs/mk2-pending-research.md) preserve the development history. All replay inputs, recorded seeds and available observations are included under `testcases/mk2/`; raw identifying network captures remain private.
