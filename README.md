...
[readable report catalog](docs/mk2-controlled-reports.md). The [latest controlled-evidence checkpoint](docs/mk2-reviewed-checkpoint-486-20260914.md) contains **486 reviewed reports: 471 exact and 15 pending** against active catalogue17, with 481 correct winners. Frozen private candidates match the 15 pending reports within their tested scopes; no correction is installed. The ten new cases retain original recorded seeds and both captured timestamp exceptions. This checks winners, all six survivor counts and every explicit supported chance-skill count within the tested scope. Separate external inbox cases still include mismatches and unsupported profiles. Earlier [campaign evidence](docs/mk2-campaign-20260913.md) and [research notes](docs/mk2-pending-research.md) preserve the development history. All replay inputs, recorded seeds and available observations are included under `testcases/mk2/`; raw identifying network captures remain private.
