...
[readable report catalog](docs/mk2-controlled-reports.md). The [latest T10 Lancer checkpoint](docs/mk2-opposing-t10-lance-pending-20260913.md) contains **476 reviewed controlled reports: 471 exact and 5 pending** using recorded seeds. The original 471 remain exact; five new opposing T10 Lancer cases expose a scheduling gap, with the frozen alternative matching all five and no correction installed. This checks winners, all six survivor counts and every explicit supported chance-skill count within the tested scope. Separate external inbox cases still include mismatches and unsupported profiles. Earlier [campaign evidence](docs/mk2-campaign-20260913.md) and [research notes](docs/mk2-pending-research.md) preserve the development history. All replay inputs, recorded seeds and available observations are included under `testcases/mk2/`; raw identifying network captures remain private.
